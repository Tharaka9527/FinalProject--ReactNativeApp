...
class RegisterForm extends Component {
  ...
  processUpload = (imageUrl) => {
    ...
    database.ref('/categories/' + imageId).set(photoObj);
    database.ref('/users/' + userId + '/categories/' + imageId).set(photoObj);
      ...
      <View style={{flex: 1}}>
        {this.state.loggedin == true ? (
          ...
          <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
            <Text style={{marginBottom: 10, fontSize: 18}}>Please Upload Your Company Logo</Text>
            <Text style={{marginBottom: 20}}>*Required</Text>
